...
<body style="background-color: #343434;">
    ...
    %>    
        ...
        <h2 class="display-4 text-center text-white" data-aos="fade-down" id="first-heading">Sign Up</h2>
        
        <div class="container col-md-5 mx-auto" id="signup-container">
            <form class="text-center border rounded" method="post" style="background-color: #626262;opacity: 0.79;" action="joinAction.jsp">
                <h2 class="sr-only">Login Form</h2>
					...
					<div class="form-group" style="text-align: center;">
						<div class="btn-group" data-toggle="buttons">
							...
							<input type="radio" name="userType" autocomplete="off" value="동아리원" checked>동아리원
							</label> 
							<label class="btn btn-secondary"> <input type="radio"
								name="userType" autocomplete="off" value="졸업생">졸업생
							</label>
						</div>
					</div>
                     <div class="form-group">
                	  ...
                	  <button class="btn btn-primary btn-block form-control" type="submit" style="background-color: rgb(52,52,52); border:1px solid #dddddd">회원가입</button>
                </form>
        </div>
        </div>
    </section>
